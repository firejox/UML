...
#define TOOL_PLUGIN_RES_PATH "/tool_plugin/composition_line_plugin/"

static tool_plugin_t composition_line_plugin = {
    .resource_path = TOOL_PLUGIN_RES_PATH "composition_line_plugin.ui",
    .style_path = TOOL_PLUGIN_RES_PATH "composition_line_plugin.css",
...
tool_plugin_t *tool_plugin_init(void) {
    if (!data) {
        ...
        data->fact = composition_line_factory_create ();
    }
