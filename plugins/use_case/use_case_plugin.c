#include "use_case_plugin.h"
#include <gtk/gtk.h>

static use_case_data_t *data = NULL;
...
#define SELECT_PLUGIN_RES_PATH "/tool_plugin/use_case_plugin/"

static tool_plugin_t use_case_plugin = {
    .resource_path = SELECT_PLUGIN_RES_PATH "use_case_plugin.ui",
    .style_path = SELECT_PLUGIN_RES_PATH "use_case_plugin.css",
    .button_name = "use_case_btn",
    .menu_name = NULL,
...
tool_plugin_t *tool_plugin_init(void) {
    if (!data) {
        use_case_plugin_register_resource();

        data = xcalloc (1, sizeof (use_case_data_t));
    }

    return &use_case_plugin;
}
