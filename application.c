...
/*************************** load tool bar **************************/
    ...
    uml_toolbar = gtk_builder_get_object (main_build, "UML_toolbar");

/******************** origin_btn load and initial ********************/
    origin_btn = gtk_builder_get_object (main_build, "origin_btn");
...
/************************ menu item initial *************************/
    ...
    edit_item = gtk_builder_get_object (main_build, "edit_menu");

/*********************** drawing area initial *********************/

    d_area = gtk_builder_get_object (main_build, "UML_canvas");
